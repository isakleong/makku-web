                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{ route('admin.product.item.store') }}" method="POST" class="form form-vertical" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12 mt-1">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="slug" id="slug_en" value="en" checked/>
                                                        <label class="form-check-label" for="slug_en">English</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="slug" id="slug_id" value="id"/>
