    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Product category master data</p>
            </div>
        </div>
    </div>
    <section class="section">
        <div class="card">
            <div class="card-header">
                <div class="buttons">
                    <a href="/admin/product/category/create" class="btn btn-outline-primary">Add Data</a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        @foreach ($category as $item)
                            <tr>
                                ...
                                @endif
                                <td>
                                    <a href="{{ route('product.category.edit', $item->id) }}" class="btn icon btn-sm btn-primary d-inline-block m-1-block m-1" data-bs-toggle="tooltip" title="Edit"><i class="bi bi-pencil"></i></a>
                                    <form action="{{ route('product.category.destroy', $item->id) }}" method="POST" class="d-inline-block m-1-block m-1" data-bs-toggle="tooltip" title="Delete">
                                        @csrf
                                        @method('DELETE')
