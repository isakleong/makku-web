                    ...
                    <tbody>
                        ...
                        @foreach ($keyFeature as $item)
                            <tr>
                                ...
                                @endif
                                <td>
                                    <a href="{{ route('keyfeature.edit', $item->id) }}" class="btn icon btn-sm btn-primary"><i class="bi bi-pencil"></i></a>
                                </td>
                                <td>
                                    <form action="{{ route('keyfeature.destroy', $item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
