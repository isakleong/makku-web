...
@section('title', 'Makku Frozen Food - Product Highlight')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Product highlight master data in Homepage</p>
            </div>
        </div>
    </div>
    <section class="section">
        <div class="card">
            <div class="card-header">
                <div class="buttons">
                    <a href="/admin/master/producthighlight" class="btn btn-outline-primary">Back</a>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <form action="{{ route('admin.master.producthighlight.update', $producthighlight->id) }}" method="POST" class="form form-vertical" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="name_en" class="form-control"
                                                            name="name_en" placeholder="Name (English)" value="{{$producthighlight->name_en}}">
                                                    </div>
                                                    @error('name_en')
                                                ...
                                                <div class="col-12 mt-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="name_id" class="form-control"
                                                            name="name_id" placeholder="Name (Indonesia)" value="{{$producthighlight->name_id}}">
                                                    </div>
                                                    @error('name_id')
                                                        <p style="color: red">{{$message}}</p>
                                                    @enderror
                                                ...
                                                <div class="col-12 mt-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="orderNumber" class="form-control"
                                                            name="orderNumber" placeholder="Order Number" value="{{$producthighlight->orderNumber}}">
                                                    </div>
                                                    @error('orderNumber')
                                                        <p style="color: red">{{$message}}</p>
                                                    @enderror
                                                ...
                                                <div class="col-12 mt-3">
                                                    <div class="form-group">
                                                        <div class="form-check form-switch">
                                                            <input name="active" class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" {{ $producthighlight->active=='1' ? 'checked' : '' }}>
