    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Partnership</h3>
                <p class="text-subtitle text-muted">Partnership master data in Homepage</p>
            </div>
        </div>
    </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($partnership as $item)
                            <tr>
                                ...
                                @endif
                                <td>
                                    <a href="{{ route('partnership.edit', $item->id) }}" class="btn icon btn-sm btn-primary d-inline" data-bs-toggle="tooltip" title="Edit"><i class="bi bi-pencil"></i></a>
                                    <form action="{{ route('partnership.destroy', $item->id) }}" method="POST" class="d-inline" data-bs-toggle="tooltip" title="Delete">
                                        @csrf
                                        @method('DELETE')
