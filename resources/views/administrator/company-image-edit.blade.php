                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <form action="{{ route('admin.master.companyimage.update', $companyimage->id) }}" method="POST" class="form form-vertical" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-body">
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="mb-3">
                                                            ...
                                                            @if ($companyimage->image != "")
                                                                <img src="/{{$companyimage->image}}" alt="" class="img-preview img-fluid mb-3 mt-3 col-4 d-block"> 
                                                            @else
                                                ...
                                                <div class="col-12 mt-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="orderNumber" class="form-control"
                                                            name="orderNumber" placeholder="Order Number" value="{{$companyimage->orderNumber}}">
                                                    </div>
                                                    @error('orderNumber')
                                                        <p style="color: red">{{$message}}</p>
                                                    @enderror
