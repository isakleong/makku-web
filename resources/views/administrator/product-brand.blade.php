                    ...
                    <tbody>
                        ...
                        @foreach ($brand as $item)
                            <tr>
                                ...
                                @endif
                                <td>
                                    <a href="{{ route('brand.edit', $item->id) }}" class="btn icon btn-sm btn-primary d-inline" data-bs-toggle="tooltip" title="Edit"><i class="bi bi-pencil"></i></a>
                                    <form action="{{ route('brand.destroy', $item->id) }}" method="POST" class="d-inline" data-bs-toggle="tooltip" title="Delete">
                                        @csrf
                                        @method('DELETE')
