    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>News</h3>
                <p class="text-subtitle text-muted">News master data</p>
            </div>
        </div>
    </div>
    <section class="section">
        <div class="card">
            <div class="card-header">
                <div class="buttons">
                    <a href="/admin/news" class="btn btn-outline-primary">Back</a>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <form action="{{ route('news.update', $news->id) }}" method="POST" class="form form-vertical" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-body">
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="choices form-select" id="categoryID"  name="categoryID">
                                                            @foreach($category as $item)
                                                                ...
                                                                @if ($item->name_en == $categorySelected->name_en)
                                                ...
                                                <div class="col-12 mt-1">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="choices form-select" id="articleID"  name="articleID">
                                                            @foreach($article as $item)
                                                                @if ($item->title_en == $articleSelected->title_en)
                                                ...
                                                <div class="col-12 mt-3">
                                                    <div class="form-group">
                                                        <div class="form-check form-switch">
                                                            <input name="active" class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" {{ $news->active=='1' ? 'checked' : '' }}>
